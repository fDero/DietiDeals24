...
import backend.request.AccountRegistrationRequest;
import backend.request.RegistrationConfirmationRequest;
import backend.service.AccountValidationService;
import backend.service.CacheManagementService;
import backend.service.EmailService;
import backend.service.EncryptionService;
import backend.temporary.PendingAccountRegistration;
...
public class RegistrationController {
    ...
    @PostMapping("/register/initialize_registration")
    ...
    @PostMapping("/register/confirm_registration")
